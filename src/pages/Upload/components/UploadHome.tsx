...
export const UploadHome: React.FC<UploadHomeProps> = ({ handleUpload, handleDragUpload }) => {
    ...
    return <StyledUploadHome>
        <div id="upload-panel" className={`${dragging ? 'dragging' : ''}`} onDragEnter={handleDragEnter} onDragLeave={handleDragLeave} onDragOver={e => e.preventDefault()} onDrop={handleDrop}>
