...
export const Hero = ({}: HeroProps): JSX.Element => {
    return (
        <StyledHero>
            <div id='hero-background'>
                <img src='https://images.pexels.com/photos/6445381/pexels-photo-6445381.jpeg?auto=compress&cs=tinysrgb&fit=crop&fp-y=0.54&h=500&sharp=20&w=1400'
            ...
            <div id='hero-content'>
                ...
                <SearchBar margin='0' placeholder='Search for free photos or videos'></SearchBar>
            </div>
        </StyledHero>
    )
}   